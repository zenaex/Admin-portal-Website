    ...
    <div className="min-h-screen bg-[#F2F4F7] flex flex-col font-sans">
      ...
      <main className="flex-grow pt-32 pb-24 px-6 md:px-12 lg:px-[110px] w-full max-w-[1440px] mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24 max-w-5xl mx-auto">
          ...
          {/* Card 1 */}
          <div className="bg-white rounded-3xl p-8 flex flex-col items-start min-h-[220px]">
        ...
        <section className="bg-white rounded-[32px] p-8 md:p-12 lg:p-16 max-w-5xl mx-auto shadow-sm">
          ...
          <form className="max-w-3xl mx-auto flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <input 
                ...
                className="w-full bg-[#F2F4F7] rounded-xl px-5 py-4 text-primary-black placeholder:text-[#A3A3A3] focus:outline-none focus:ring-2 focus:ring-primary-green"
              />
              <input 
                type="text" 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex gap-2 w-full">
                <div className="bg-[#F2F4F7] rounded-xl px-4 py-4 flex items-center gap-2 min-w-[100px] shrink-0">
            ...
            <div className="relative w-full">
              <select 
                className="w-full bg-[#F2F4F7] rounded-xl px-5 py-4 text-primary-black placeholder:text-[#A3A3A3] appearance-none focus:outline-none focus:ring-2 focus:ring-primary-green cursor-pointer"
                defaultValue=""
              >
            ...
            <textarea 
              ...
              rows={5}
              className="w-full bg-[#F2F4F7] rounded-xl px-5 py-4 text-primary-black placeholder:text-[#A3A3A3] resize-none focus:outline-none focus:ring-2 focus:ring-primary-green"
            />
