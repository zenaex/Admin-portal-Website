    ...
    <section className="relative flex flex-col justify-center min-h-[500px] md:min-h-[600px] lg:min-h-[750px] overflow-hidden bg-[#0A0A0A]" id="security">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-8 md:px-12 lg:px-[110px]">
        ...
        <div className="flex flex-col text-white max-w-md lg:max-w-lg xl:max-w-xl md:py-16">
          ...
          {/* Download CTA Card */}
          <div className="flex items-center gap-4 rounded-lg bg-white pl-3 pr-7 py-3 md:pl-4 md:pr-8 md:py-3.5 w-fit">
            {/* QR Code */}
            <img
              src={qrCodeImg}
            ...
            <div className="flex flex-col gap-1.5 justify-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href="#"
                  className="flex items-center justify-center gap-2 rounded-lg bg-black px-3 py-1.5 transition-transform hover:scale-105 active:scale-95"
                >
