    ...
    <header className={`absolute top-0 left-0 w-full z-50 pt-4 md:pt-10`}>
      <div className="mx-auto flex h-[45px] w-full max-w-[1440px] items-center justify-between px-8 md:px-12 lg:px-[110px]">
        ...
        <div className="flex items-center gap-4 md:hidden">
          <Button to="/waitlist" variant="primary" className="!px-4 !py-2 !text-xs">Pre-Register</Button>
          <button
            className={`${textColor}`}
        ...
        <div className="hidden items-center gap-12 md:flex">
          ...
          <Button to="/waitlist" variant="primary" className="!px-6 !py-2.5 !text-sm">Pre-Register</Button>
        </div>
      </div>
